...
- 웹 문서의 모양을 기술하기 위해 사용하는 마크업 언어 (Markup Language)
...
- 여는 태그 내에서 명령어를 구체화하는 속성
<br> (```<tag element="">```)

### HTML 변수 (HTML arguments)
- 태그 내의 속성에 해당되는 변수
<br> (```<tag element="value">```)

### HTML 주석 (HTML arguments)
```
<!--? 주석 -->
```
...
#####  ```<meta http-equiv="reply-to">``` : 클라이언트가 문의할 이메일을 지정하는 http-equiv 변수 ("reply-to" 대신 "email"도 가능)
...
##### ```<meta http-equiv="X-UA-Compatible">``` : 웹 문서를 렌더링할 IE 버전을 명시하여 웹의 호환성을 지정하는 http-equiv 변수
...
##### ```<meta http-equiv="page-enter">``` : 현재 웹 문서로 접속할 때의 장면 전환 효과를 지정하는 http-equiv 변수

##### ```<meta http-equiv="page-exit">``` : 현재 웹 문서를 종료할 때의 장면 전환 효과를 지정하는 http-equiv 변수

##### ```<meta http-equiv="site-enter">``` : 다른 웹 사이트에서 현재 웹 사이트로의 장면 전환 효과를 지정하는 http-equiv 변수

##### ```<meta http-equiv="site-exit">``` : 현재 웹 사이트에서 다른 웹 사이트로의 장면 전환 효과를 지정하는 http-equiv 변수
